...
class TimberCuttingPermitApplicationAction
{
    ...
    public static function store(array $timberCuttingPermitApplication, User $authUser = null)
    {
        ...
        try {
            ...
            $timberCuttingPermitApplication->gn_division = $gnDivision;
            $timberCuttingPermitApplication->deed_detail = $deedDetails;
            $timberCuttingPermitApplication->land_detail = $landDetails;
            $timberCuttingPermitApplication->boundaries = $boundaries;
