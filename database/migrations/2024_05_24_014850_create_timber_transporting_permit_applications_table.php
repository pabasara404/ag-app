...
return new class extends Migration
{
    ...
    {
        Schema::create('timber_transporting_permit_applications', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->foreignId('private_land_detail_id')->nullable()->references('id')->on('private_land_details');
    ...
    {
        Schema::dropIfExists('timber_transporting_permit_applications');
    }
};
