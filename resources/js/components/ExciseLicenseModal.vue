      ...
      <n-form ref="formRef" :model="formValue">
          ...
          <n-card v-if="!isNewApplication">
              ...
              <n-form-item label="Date of Issue" path="nature">
                  <n-date-picker v-model:value="selectedIssuedDate" type="expire_date" /> </n-form-item>
              <n-form-item label="Date  of Expire" path="nature">
                  <n-date-picker v-model:value="selectedExpireDate" type="expire_date" /> </n-form-item>
          </n-card>
